      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "20px" }}>
        ...
        <div className="page-card" style={{ display: "flex", flexDirection: "column", justifyContent: "space-between", height: "100%", margin: 0 }}>
          ...
          <button 
            ...
            onClick={() => exportFile("/export/neraca-saldo", generateDownloadName("Neraca_Saldo"))}
          >
        ...
        <div className="page-card" style={{ display: "flex", flexDirection: "column", justifyContent: "space-between", height: "100%", margin: 0 }}>
          ...
          <button 
            className="btn-primary" 
            style={{ width: "100%", background: "#16a34a", justifyContent: "center" }}
            onClick={() => exportFile("/export/buku-besar", generateDownloadName("Buku_Besar"))}
          >
        ...
        <div className="page-card" style={{ display: "flex", flexDirection: "column", justifyContent: "space-between", height: "100%", margin: 0 }}>
          ...
          <button 
            className="btn-primary" 
            style={{ width: "100%", background: "#16a34a", justifyContent: "center" }}
            onClick={() => exportFile("/export/laba-rugi", generateDownloadName("Laba_Rugi"))}
          >
        ...
        <div className="page-card" style={{ display: "flex", flexDirection: "column", justifyContent: "space-between", height: "100%", margin: 0 }}>
          ...
          <button 
            className="btn-primary" 
            style={{ width: "100%", background: "#16a34a", justifyContent: "center" }}
            onClick={() => exportFile("/export/neraca", generateDownloadName("Neraca_Lajur"))}
          >
        ...
        <div className="page-card" style={{ display: "flex", flexDirection: "column", justifyContent: "space-between", height: "100%", margin: 0 }}>
          ...
          <button 
            className="btn-primary" 
            style={{ width: "100%", background: "#16a34a", justifyContent: "center" }}
            onClick={() => exportFile("/export/piutang", generateDownloadName("Rekap_Piutang"))}
          >
        ...
        <div className="page-card" style={{ display: "flex", flexDirection: "column", justifyContent: "space-between", height: "100%", margin: 0 }}>
          ...
          <button 
            className="btn-primary" 
            style={{ width: "100%", background: "#16a34a", justifyContent: "center" }}
            onClick={() => exportFile("/export/hutang", generateDownloadName("Rekap_Hutang"))}
          >
